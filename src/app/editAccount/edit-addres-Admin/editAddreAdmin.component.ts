...
@Component({
  selector: 'app-edit-address-admin',
  templateUrl: './editAddreAdmin.component.html',
  styleUrls: ['./editAddreAdmin.component.scss']
})
export class EditAddressAdminComponent implements OnInit {
  ...
  constructor(private newService: CommonService) {
    this.User_id= localStorage.getItem("idAccount");
